...
from src.core.deps import get_performance_role_service
...
@router.post("/", status_code=status.HTTP_201_CREATED, response_model=PerformanceRoleRead)
...
@router.get("/{performance_role_id}", response_model=PerformanceRoleRead)
...
@router.patch("/{performance_role_id}", response_model=PerformanceRoleRead)
...
@router.delete("/{performance_role_id}", response_model=MessageResponseSchema)
