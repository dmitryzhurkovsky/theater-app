...
if TYPE_CHECKING:
    from backend.src.models.performance_role import TheatricalRole
...
class User(BaseModel, TimestampAbstractModel):
    ...
    user_roles: Mapped[list[UserRoleTypeEnum]] = mapped_column(pg.ARRAY(Enum(UserRoleTypeEnum)), nullable=False)
