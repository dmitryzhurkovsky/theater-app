...
class TheatricalRoleController(BaseService):
    ...
    async def list_theatrical_roles(
    ...
    async def create_theatrical_role(
        self, theatrical_role: TheatricalRoleCreate
    ) -> TheatricalRole:
    ...
    async def update_theatrical_role(
        self, thr_id: int, theatrical_role: TheatricalRoleUpdate
    ) -> TheatricalRole:
        return await self.theatrical_role_manager.update(
            thr_id, theatrical_role.model_dump()
        )
